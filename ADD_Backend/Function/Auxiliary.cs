...
namespace ADD_Backend.Function
{
    /// <summary>
    /// Auxiliary class
    /// </summary>
    public static class Auxiliary
    {
        ...
        public static void ValidateStart(DateTimePicker ca_date_start, ErrorProvider ep_error)
        {
            // TODO: hardcoded text
        ...
        /// <param name="ep_error">Error indicator</param>
        public static void ValidateEnd(DateTimePicker start, DateTimePicker end, ErrorProvider ep_error)
        {
            // TODO: hardcoded text
            StringBuilder errBuilder = new StringBuilder();
        ...
        /// <param name="end">End date DateTimePicker control</param>
        /// <param name="ep_error">Error indicator</param>
        public static void ValidateRange(DateTimePicker start, DateTimePicker end, ErrorProvider ep_error)
        {
            // TODO: hardcoded text
        ...
        /// <param name="ep_error">Error indicator</param>
        public static void ValidateMonth(DateTimePicker mp, ErrorProvider ep_error)
        {
            // TODO: hardcoded text
            StringBuilder errBuilder = new StringBuilder();
        ...
        public static int DaysDiff(DateTime str, DateTime end)
        {
            int diff = 0;
            DateTime aux = str;
        ...
        // TODO: comment
        public static DateTime MonthStart(DateTime month)
        {
            return new DateTime(month.Year, month.Month, 1);
        }
        public static DateTime MonthEnd(DateTime month)
        {
